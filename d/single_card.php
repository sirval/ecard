                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <div class="home_btns m-top-10 text-rights">
                                    <a style="color: #000000;"  class="btn btn-info m-top-5" href="print_card.php">Print</a>
                                    <a style="color: #000000;" class="btn btn-primary m-top-5" href="<?php $uri=40; echo 'index.php?mode=single_view+id='.md5($uri); ?>">Back</a>
  ...
  #c_right{
   ...
   <?php
        ...
        if (isset($_GET['id']) && $_GET['id'] !=='' ) {
                ...
                $i=0;
		$get_costumers="SELECT * FROM customer WHERE customer_id = '$userid'";
